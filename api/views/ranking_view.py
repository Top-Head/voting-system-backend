...
class SubcategoryProjectRankingView(APIView):
    ...
    def get(self, request, subcategory_id):
        ...
        projects = (
            Project.objects.filter(subcategory=subcategory)
        ...
        for project in projects:
            members = (
                ...
                else project.member_set.all()
            )
            members_data = [
                {"name": member.name, "classe": member.classe, "turma": member.turma}
            ...
            data.append(
                {
                    ...
                    "category_name": (
                        project.category.name if project.category else None
                    ),
